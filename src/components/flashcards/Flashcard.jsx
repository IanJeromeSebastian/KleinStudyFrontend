  ...
  return (
    <div className='relative w-full h-72' style={{ perspective: '1000px' }}>
      <div
        ...
        {/* back */}
        <div 
        className='absolute inset-0 w-full h-full bg-linear-to-br from-[#FFDD8A] to-[#FFC84D] border-[#FFDD8A]/60 rounded-2xl shadow-xl shadow-[#FFC84D]/30 p-8 flex flex-col justify-between'
        style={{
          backfaceVisibility: 'hidden',
          WebkitBackfaceVisibility: 'hidden',
