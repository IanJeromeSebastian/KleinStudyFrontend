...
const DashboardPage = () => {
  ...
  const stats = [
  {
    ...
    icon: FileText,
    isImage: false,
    gradient: 'from-[#b19ff9] to-[#c4b5fd]', 
    shadowColor: 'shadow-[#b19ff9]/40',
  },
  {
    ...
    icon: BookOpen,
    isImage: false,
    gradient: 'from-[#ffab91] to-[#ffccbc]',
    shadowColor: 'shadow-[#ffab91]/40',
  },
  {
    label: 'Total Quizzes',
    ...
    icon: BookStudyIcon,
    isImage: true,
    gradient: 'from-[#90caf9] to-[#cbebf9]',
    shadowColor: 'shadow-[#90caf9]/40',
  },
];
      ...
      <div className='absolute inset-0 bg-[radial-gradient(#e5e7eb_1px, transparent_1px)] bg-size-[16px_16px] opacity-30 pointer-events-none'/>
        ...
        <div className='relative max-w-7xl mx-auto'>
          <div className='mb-6'>
            ...
            <p className='text-slate-600 text-sm'>Track your learning progress and activity</p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-5'>
            {stats.map((stat, index)=>(
              <div 
                key={index}
                className='group relative bg-[#faf4f1]/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-6 hover:shadow-2xl hover:shadow-slate-300/50 transition-all duration-300 hover:translate-y-1'>
                  ...
                  <stat.icon className="w-5 h-5 text-slate-700" strokeWidth={2.5}/>
                )}
                    </div>
                  </div>
          ...
          <div className='bg-[#faf4f1]/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-8'>
            <div className='flex items-center gap-3 mb-6'>
              <div className='w-10 h-10 rounded-xl bg-linear-to-br from-slate-300 to-slate-400 flex items-center justify-center'>
                ...
                {[
                  ...
                  .map((activity, index) =>(
                    <div
                      ...
                      className='group flex items-center justify-between p-4 rounded-xl bg-slate-50/50 border border-slate-200/60 hover:bg-[#e4dcd7] hover:border-slate-300/60 hover:shadow-md transition-all duration-200'
                    >
                      <div className='flex-1 min-w-0'>
                        <div className='flex items-center gap-2 mb-1'>
                          <div className={`w-2 h-2 rounded-full ${
                            activity.type === 'document'
                            ? 'bg-linear-to-br from-[#b19ff9] to-[#c4b5fd]'
                            : 'bg-linear-to-br from-[#90caf9] to-[#cbebf9]'
                          }`}/>
                      ...
                      {activity.link && (
                        ...
                        className='ml-4 px-4 py-2 text-xs font-semibold text-[#ffd700] hover:text-[#ffae00] hover:bg-[#ffd700] rounded-lg transition-all duration-200 whitespace-nowrap'>View</a>
                      )}
                    </div>
                  ))}
              </div>
